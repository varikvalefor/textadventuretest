...
ni'o la'au le mu'oi glibau.\ low-level .glibau.\ li'u vasru le velcki be le fancu poi ke'a co'e ja pruce zo'e je lo ctaipe be la'oi .\F{GameData}.\ lo ctaipe be la'oi .\F{GameData}.\ je lo ctaipe be zo'e ja lo su'u dunli
...
smashGeneric q k x j = q' , kuslendus , xindus , itemstedus
  ...
  xindus = begin
    ...
    𝓁 i ≡⟨ cong 𝓁 $ teikdrop i x ⟩
    𝓁 (d₁ ++ i ! x ∷ d₃) ≡⟨ DLP.length-++ d₁ ⟩
    𝓁 d₁ + 𝓁 (i ! x ∷ d₃) ≡⟨ refl ⟩
    𝓁 d₁ + 𝓁 (j' ∷ d₃) ≡⟨ sym $ DLP.length-++ d₁ ⟩
    𝓁 (d₁ ++ j' ∷ d₃) ≡⟨ cong 𝓁 $ sym $ ualkonk i x $ const j' ⟩
    𝓁 (Room.items snikerz) ≡⟨ cong (𝓁 ∘ Room.items) snidus ⟩
...
\section{le fancu poi ke'a co'e ja pruce zo'e je ko'a goi lo ctaipe be la'oi .GameData.\ ko'a je zo'e}
...
\section{le fancu poi cumki fa lo nu ke'a co'e ja pruce zo'e je ko'a goi lo ctaipe be la'oi .GameData.\ zo'e je lo na du be ko'a}
...
\begin{itemize}
	...
	\begin{itemize}
		\item ga jonai ko'a me'oi .\AgdaInductiveConstructor{just}.\ lo .orsi be li re bei lo te skuxai ja zo'e bei la'oi .\B g.\ gi
		\item ga je la'o zoi.\ \AgdaField{Room.travis} \OpF \$ \AgdaField{Character.room} \OpF \$ \AgdaField{GameData.player} \B g .zoi.\ vasru lo mu'oi glibau.\ \AgdaField{Room.cname}\ .glibau.\ be la'oi .\B K.\ gi ko'a me'oi .\AgdaInductiveConstructor{just}.\ lo .orsi be li re bei lo velski be lo nu klama kei bei zo'e poi tu'a ke'a .indika lo du'u ko'e zvati zo'e poi djica lo nu zvati ke'a xi re
	\end{itemize}
\end{itemize}
...
ni'o ro da poi ke'a co'e zo'u ga jonai ga je djuno pe'a ru'e lo du'u tu'a la'o zoi.\ \B s\ .zoi.\ .indika lo du'u lo kelci cu djica lo nu marxa da gi ga jonai ga je curmi lo nu marxa da gi ga je tu'a la'o zoi.\ \B x\ .zoi.\ lu'u je tu'a la'o zoi.\ \B z .zoi.\ cu .indika lo du'u marxa da gi ko'a goi la'o zoi.\ \F{smash?} \B s \B g\ .zoi.\ du la'o zoi.\ \F{just} \OpF \$ \B x \OpF , \B z\ .zoi.\ gi ga je la'o zoi.\ \B x\ .zoi.\ se skuxai ja co'e gi ko'a du la'o zoi.\ \F{just} \OpF \$ \B x \OpF , \B g\ .zoi.\ gi ko'a du la'oi .\F{nothing}.
