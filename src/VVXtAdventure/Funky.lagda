...
ni'o ga jo la'o zoi.\ \B S\ .zoi.\ du la'o zoi.\ \F{smashGeneric}\ \B q \B k \B x \B j\ .zoi.\ gi ga je la'o zoi.\ \F{proj₁}\ \B S\ .zoi.\ smimlu la'o zoi.\ \B q\ .zoi.\ gi ku'i la'o zoi.\ \F{Room.items}\ (\F{GameData.rooms}\ (\F{proj₁}\ \B S) \OpF !\ \F{mink}\ \B k\ (\F{proj₁}\ \OpF \$\ \F{proj₂}\ \B S)) \OpF !\ \F{mink}\ \B x\ (\F{proj₁} \OpF \$\ \F{proj₂}\ \OpF \$\ \F{proj₂}\ \B S) .zoi.\ du lo selvau pe'a be la'o zoi.\ \F{Data.Maybe.map}\ \F{proj₂}\ \OpF \$\ \F{Item.smashInfo}\ \OpF \$\ \F{Room.items}\ (\F{GameData.rooms} \B q\ \OpF !\ \B k) \OpF !\ \B x\ .zoi.
...
\chapter{le zmiku}
ni'o la'au le zmiku li'u vasru le velcki be le se ctaipe be lo smimlu be la'o zoi.\ \F{GameData} \Sym → \F{Maybe} \OpF \$ \F{String} \OpF × \F{GameData}\ .zoi.\ be'o be'o poi tu'a ke'a na se sarcu lo nu midnoi fi lo kelci
