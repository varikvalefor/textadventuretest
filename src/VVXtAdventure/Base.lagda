...
\begin{itemize}
	...
	\item ga je ga je ko'e goi la'o zoi.\ \AgdaField{Item.cname} \B a .zoi.\ cmene ko'a gi cadga fa lo nu lo kelci cu pilno ko'e tu'a ko'a gi
        ...
        \item ga je ga jo la'o zoi.\ \B s\ .zoi.\ du la'o zoi.\ \AgdaField{Item.smashInfo}\ \B a\ .zoi.\ gi ga jonai ga je na curmi lo nu spogau ja co'e fi lo selsni be ko'a gi ko'a goi la'o zoi.\ \B s\ .zoi.\ cu du la'oi .\AgdaInductiveConstructor{nothing}.\ gi\ldots
        \begin{itemize}
...
\begin{itemize}
	...
	\item ga je la'o zoi.\ \AgdaField{Room.items} \B a .zoi.\ liste lo'i selvau be lo selsni be ko'a be'o poi ke'a ba'e na prenu gi
	\item la'o zoi.\ \AgdaField{Room.velski} \B a .zoi.\ velski lo selsni be ko'a
\end{itemize}
