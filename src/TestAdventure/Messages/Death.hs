...
spontComb :: String;
spontComb = "You spontaneously combust, thereby losing the game and \
            \making yourself look like a bit of a jack-ass in the \
            \process."
...
answerAff ="You answer no one in the affirmative.\nNo one responds \
           \with a swift punch to the sternum.\n\"Gah!\"\nYou collapse \
           \to the ground, slowly melting into cheese.\nJust before \
           \dying, you awaken from your wack-ass dream and remember \
           \that you are actually the great BRIAN W. KERNIGHAN.";
